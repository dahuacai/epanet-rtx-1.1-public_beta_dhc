...
namespace RTX {
  ...
  public:
    ...
    virtual bool isConnected(){return false;} // abstract base can't have a connection;     //dhc add statement	const std::string& DbPointRecord::connectionString();//dhc  add statement
	//dhc add statement
