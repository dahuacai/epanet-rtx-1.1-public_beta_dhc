...
EpanetModel::EpanetModel() : Model() {
  ...
  OW_Project *newEpanetModel=NULL;//DHC Modify For Initialing  newEpanetModel
  _enOpened = false;
...
void EpanetModel::useEpanetFile(const std::string& filename) {
  ...
  //dhc disable because line 75 have been set
  //this->setQualityUnits(RTX_MICROSIEMENS_PER_CM);
  //dhc disable  because line 73 have been set
